...
<!-- <div class="banner">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"><span>Y</span>ATRA</h1>
	</div>
</div> -->
<div class="video-container">
    <!-- <video >
      <source src="..video/vid1.mp4" type="video/mp4"> -->
	  <video src="video/vid-3.mp4" id="video-slider" loop autoplay muted></video>
